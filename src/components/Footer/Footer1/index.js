      ...
      <footer className={props.className}>
        <Column className="flex flex-col items-center justify-start sm:mb-[43px] md:mb-[55px] mb-[81px] sm:mt-[31px] md:mt-[41px] mt-[60px] mx-[auto] sm:w-[100%] w-[82%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start mt-[2px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[13%] common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list">
              <ul className="flex flex-col">
                <Column className="cursor-pointer flex flex-col justify-start common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list">
                  <ul className="flex flex-col">
                    <li className="w-[auto]">
                      <Text
            ...
            <Column className="flex flex-col items-end justify-start ml-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[78%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between w-[100%]">
                <Column className="flex flex-col justify-start mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%] common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list">
                  <ul className="flex flex-col">
                    <li className="w-[auto]">
                      <Text
                        className="cursor-pointer font-inter font-medium text-white_A700"
                ...
                <Column className="flex flex-col justify-start mt-[2px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[23%] common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list common-column-list">
                  <ul className="flex flex-col">
                    <li className="w-[auto]">
                      <Text
                        className="cursor-pointer font-inter font-medium text-white_A700"
