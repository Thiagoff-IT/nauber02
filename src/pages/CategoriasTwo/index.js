          ...
          <Column className="absolute bottom-[0] flex flex-col inset-x-[0] items-center justify-start sm:mx-[0] mx-[auto] sm:px-[0] sm:w-[100%] w-[86%]">
              ...
              <Stack className="h-[279px] my-[0] relative w-[100%]">
                <Stack className="absolute h-[279px] w-[100%]">
                  ...
                  <Column
                    ...
                    style={{
                      backgroundImage: "url('images/img_projetorasdet.svg')",
                    }}
                  >
                    <Text
                      className="not-italic text-white_A700_87 w-[auto]"
                      variant="body6"
                    >
                ...
                <Row className="absolute bottom-[10%] flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between left-[1%] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[95%]">
                  ...
                  >
                    <Text
                      className="mt-[3px] not-italic text-white_A700_87 w-[auto]"
                      variant="body6"
                    >
                      demarcação viária
                    </Text>
              ...
              <Stack className="h-[279px] my-[0] relative rotate-[180deg] w-[100%]">
                <Stack className="absolute h-[279px] w-[100%]">
                  ...
                  <Column
                    ...
                    style={{
                      backgroundImage: "url('images/img_aspiradores.svg')",
                    }}
                  >
                    <Text
            ...
            <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[15px] sm:mt-[7px] w-[100%]">
              <Stack className="h-[279px] relative w-[100%]">
                ...
                >
                  <Text
                    className="not-italic text-white_A700_7f w-[auto]"
                    variant="body6"
                  >
                    compressor
                  </Text>
              ...
              <Stack className="h-[279px] md:mt-[10px] mt-[15px] sm:mt-[7px] relative rotate-[180deg] w-[100%]">
                ...
                <Row className="absolute flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between rotate-[180deg] w-[100%]">
                  ...
                  >
                    ...
                    >
                      <Text
                        className="sm:mr-[42px] md:mr-[55px] mr-[80px] not-italic text-white_A700_7f w-[auto]"
                        variant="body6"
                      >
                        pistolas airless
                      </Text>
              ...
              <Stack className="h-[279px] md:mt-[10px] mt-[15px] sm:mt-[7px] relative w-[100%]">
                <Stack className="absolute h-[279px] w-[100%]">
                  <Img
                    src="images/img_vector94_279X455.png"
                    className="absolute h-[279px] inset-x-[32%] max-w-[100%] w-[37%]"
                    alt="VectorNinetyFour One"
                  />
                  <Column
                    className="absolute bg-cover bg-no-repeat flex flex-col justify-end sm:mx-[0] sm:p-[3px] md:p-[4px] p-[7px] sm:w-[100%] w-[37%]"
                    style={{
                  ...
                  >
                    ...
                    >
                      <Text
                        className="sm:mr-[22px] md:mr-[29px] mr-[43px] not-italic text-white_A700_87 w-[auto]"
                        variant="body6"
                      >
                  ...
                  >
                    <Column
                      className="bg-cover bg-no-repeat flex flex-col items-center justify-start sm:mb-[10px] md:mb-[13px] mb-[19px] sm:mt-[107px] md:mt-[138px] mt-[201px] sm:mx-[0] pt-[1px] px-[1px] sm:w-[100%] w-[88%]"
                      style={{
                        backgroundImage: "url('images/img_projetorasdet.svg')",
                      }}
                    >
                ...
                <Column
                  className="absolute bg-cover bg-no-repeat bottom-[10%] flex flex-col inset-x-[0] items-center justify-start sm:mx-[0] mx-[auto] sm:pt-[3px] md:pt-[4px] pt-[7px] sm:px-[3px] md:px-[4px] px-[7px] sm:w-[100%] w-[32%]"
                  style={{
                    backgroundImage: "url('images/img_projetorasdet.svg')",
                  }}
                >
...
export default CategoriasTwoPage;
