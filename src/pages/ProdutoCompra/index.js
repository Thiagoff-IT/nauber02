        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[15px] sm:mt-[7px] w-[100%]">
            <Stack className="h-[63px] relative w-[100%]">
              <Img
                src="images/img_vector117_1.png"
            ...
            <Column className="bg-gradient4  flex flex-col items-end justify-start max-w-[370px] sm:mt-[38px] md:mt-[49px] mt-[72px] sm:mx-[0] mx-[auto] md:p-[23px] p-[34px] sm:px-[15px] sm:py-[18px] rounded-radius6 w-[100%]">
              <Text
                className="leading-[normal] sm:mx-[0] text-center text-white_A700 sm:w-[100%] w-[96%]"
                variant="body14"
              >
                não localizimos um revendedor,
                <br />
                Compre agora mesmo!
              </Text>
              <Text
                className="sm:mt-[15px] md:mt-[20px] mt-[30px] text-white_A700 w-[auto]"
                as="h2"
                variant="h2"
              >
                R$999,99
              ...
              <Column className="flex flex-col font-inter items-center justify-start mb-[2px] mr-[3px] md:mt-[10px] mt-[15px] sm:mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[99%]">
                <Input
                  value={inputvalue}
            ...
            <Column className="flex flex-col items-center justify-start max-w-[1170px] md:mt-[110px] mt-[161px] sm:mt-[85px] sm:mx-[0] mx-[auto] sm:px-[15px] w-[100%]">
              <Column className="flex flex-col justify-start w-[100%]">
                <Text
...
export default ProdutoCompraPage;
