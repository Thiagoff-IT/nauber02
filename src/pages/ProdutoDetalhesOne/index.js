        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[15px] sm:mt-[7px] w-[100%]">
            <Stack className="h-[63px] relative w-[100%]">
              <Img
                src="images/img_vector117_3.png"
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1170px] sm:mt-[26px] md:mt-[34px] mt-[50px] sm:mx-[0] mx-[auto] sm:px-[15px] w-[100%]">
              ...
              <Column className="flex flex-col md:ml-[20px] ml-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]">
                ...
                <Column className="bg-gradient4  flex flex-col justify-end sm:mt-[40px] md:mt-[52px] mt-[76px] sm:mx-[0] md:p-[13px] p-[19px] sm:px-[15px] sm:py-[10px] rounded-radius6 sm:w-[100%] w-[79%]">
                  <Column className="flex flex-col items-center justify-start ml-[2px] sm:mt-[13px] md:mt-[17px] mt-[25px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[90%]">
                    <Text
                    ...
                    <Stack className="font-inter h-[120px] sm:mt-[13px] md:mt-[17px] mt-[25px] relative w-[100%]">
                      <Text
                      ...
                      <Column className="absolute flex flex-col items-center justify-start rounded-radius628 shadow-bs1 w-[100%]">
                        <Input
                          value={inputvalue}
                        ...
                        <Input
                          ...
                          className="font-normal not-italic p-[0] text-[12px] placeholder:text-gray_500 text-gray_500 w-[100%]"
                          wrapClassName="flex md:mt-[26px] mt-[39px] sm:mt-[20px] w-[100%]"
                          name="Group122"
                    ...
                    <Text
                      className="font-inter font-normal mt-[12px] sm:mt-[6px] md:mt-[8px] not-italic text-white_A700 w-[auto]"
                      variant="body26"
                    >
                      ou
                    </Text>
                    <Stack className="font-inter h-[83px] mt-[4px] relative sm:w-[100%] w-[82%]">
                      <Column className="absolute bg-white_A700 flex flex-col h-[max-content] inset-y-[0] items-center justify-start sm:mx-[0] my-[auto] sm:p-[4px] md:p-[6px] p-[9px] right-[0] rounded-radius165 sm:w-[100%] w-[74%]">
                        <Text
                      ...
                      <Stack className="absolute bg-white_A700 h-[83px] left-[0] sm:p-[4px] md:p-[6px] p-[9px] rounded-radius50 sm:w-[44px] md:w-[57px] w-[83px]">
                        <Img
                          src="images/img_global11.png"
                          className="absolute h-[64px] inset-[0] justify-center m-[auto] max-w-[100%] sm:w-[34px] md:w-[44px] w-[64px]"
                          alt="globalEleven"
                        />
                      </Stack>
                    </Stack>
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap font-inter items-start justify-evenly mt-[12px] sm:mt-[6px] md:mt-[8px] sm:px-[0] w-[100%]">
                      <Img
            ...
            <Column className="flex flex-col justify-start max-w-[1170px] sm:mt-[45px] md:mt-[59px] mt-[86px] sm:mx-[0] mx-[auto] sm:px-[15px] w-[100%]">
              <Text
            ...
            <Footer1 className="bg-gray_900 font-inter sm:mt-[27px] md:mt-[35px] mt-[52px] w-[100%]" />
          </Column>
        </Column>
      </Column>
    </>
...
export default ProdutoDetalhesOnePage;
